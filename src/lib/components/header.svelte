	...
	>
		...
		>
			...
			>
				...
				<a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="#">Portfolio</a>
				<a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="#">Experience</a>
				<a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="#">Contact</a>
