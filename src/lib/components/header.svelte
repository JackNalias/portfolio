<header
	class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full text-sm py-3 sm:py-0 sticky top-0 bg-slate-950 border-b"
>
	<nav
	...
	>
		...
		>
			...
			>
				<a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="/#about">About</a>
				<a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="/#portfolio"
					>Portfolio</a
				>
				<a class="font-medium text-white/[.8] hover:text-white sm:py-6" href="/#process">Process</a>
